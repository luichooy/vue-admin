          ...
          <div class="patientinfo-panel">
            <el-row>
              ...
              <el-col :span="8">
                <el-row>
                  <el-col :span="8"
                    ><span class="label">身份证号：</span></el-col
                  >
                  <el-col :span="16"
                    ><span class="value">622829186403579462</span></el-col
                  >
                </el-row>
              </el-col>
            </el-row>
            <el-row>
              ...
              <el-col :span="8">
                <el-row>
                  <el-col :span="8"
                    ><span class="label">联系方式：</span></el-col
                  >
                  <el-col :span="16"
                    ><span class="value">15679523486</span></el-col
                  >
                </el-row>
              </el-col>
              <el-col :span="8">
                <el-row>
                  <el-col :span="8"
                    ><span class="label">院内编号：</span></el-col
                  >
                  <el-col :span="16"
                    ><span class="value">622829186403579462</span></el-col
                  >
            ...
            <el-row>
              <el-col :span="24">
                <el-row>
                  <el-col :span="3"
                    ><span class="label">常住地址：</span></el-col
                  >
                  <el-col :span="16"
                    ><span class="value">浙江省杭州市江干区</span></el-col
                  >
                </el-row>
              </el-col>
            </el-row>
